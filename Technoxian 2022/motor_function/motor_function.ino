...
void loop() {
  ...
  if(colors4<100 && colors5<100 && colors3<100){
      forward();
    }

  if(colors1<100 && colors2<100 && colors3<100){
      forward();
    }
  if(colors3<100 && colors4<100){
    counter = counter + 1;
    delay(100);
    forward();
  }

  if(colors3>100 && colors1>100 && colors2>100 && colors4>100 && colors5>100){
    backward();
    delay(1000);
    stop();
    right();
